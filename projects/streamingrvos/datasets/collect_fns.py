...
def video_lisa_collate_fn(instances: Sequence[Dict],
    ...
    for example in instances:
        # Check if the instances are video or image add in 6.26
        ...
        if has_image:
            pixel_values.append(example['pixel_values']) #video: example['pixel_values'].shape:[5,3,448,448] 
            if has_pe:
    ...
    if seq_parallel_world_size > 1:# pass
