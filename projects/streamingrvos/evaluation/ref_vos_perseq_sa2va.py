...
if __name__ == '__main__':
    ...
    for item in tqdm.tqdm(dataloader):
        ...
        seq_total_ms = (time.perf_counter() - seq_start_time) * 1000.0
        seq_avg_ms = seq_total_ms / max(len(item['images']), 1)
        if args.record_frame_time:
        ...
        result = {
            ...
            'seq_total_ms': seq_total_ms,
            'seq_avg_ms': seq_avg_ms,
        ...
        if args.record_frame_time:
            ...
            with open(time_path, 'w', encoding='utf-8') as f:
                ...
                f.write(f'SEQ_TOTAL_MS\t{seq_total_ms:.3f}\n')
                f.write(f'SEQ_AVG_MS\t{seq_avg_ms:.3f}\n')
