...
DATASETS_INFO = {
    ...
    'MEVIS': {
        'data_root': '/mnt/data1/zwk/data/rvos/MeViS/valid',
        'image_folder': '/mnt/data1/zwk/data/rvos/MeViS/valid/JPEGImages',
        'expression_file': '/mnt/data1/zwk/data/rvos/MeViS/valid/meta_expressions.json',
        'mask_file': None,
    },
    'MEVIS_U': {
    ...
    'REFYTVOS': {
        ...
        # 'expression_file': '/mnt/data1/zwk/data/rvos/Ref-YTB-VOS/meta_expressions/valid/meta_expressions.json',
        'mask_file': None,
    },
    'REVOS': {
        'data_root': '/mnt/data1/zwk/data/rvos/ReVOS',
        'image_folder': '/mnt/data1/zwk/data/rvos/ReVOS/JPEGImages',
        'expression_file': '/mnt/data1/zwk/data/rvos/ReVOS/meta_expressions_valid_.json',
        'mask_file': None,
    },
    'REREVOS': {
        'data_root': '/mnt/data1/zwk/data/rvos/ReVOS',
