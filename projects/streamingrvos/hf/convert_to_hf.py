...
def main():
    ...
    from projects.streamingrvos.hf.models.configuration_sa2va_chat import Sa2VAChatConfig
    from projects.streamingrvos.hf.models.modeling_sa2va_chat import Sa2VAChatModel
    ...
    # hf_sa2va_model.load_state_dict(all_state_dict)
    ...
    # copy the files
    os.system(f"cp -pr ./projects/streamingrvos/hf/models/* {args.save_path}")
