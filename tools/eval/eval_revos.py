...
import sys
sys.path.append("/video_vit/tracking/VLM/sa2va")
from third_parts.revos.utils.metrics import db_eval_iou, db_eval_boundary, get_r2vos_accuracy, get_r2vos_robustness
...
if __name__ == '__main__':
    ...
    parser.add_argument("--pred_path", type=str, default="/video_vit/tracking/VLM/sa2va/work_dirs/Sa2VA-1B-stage1-7-8/REREVOS/results.json")
    parser.add_argument("--exp_path", type=str, default="/video_vit/tracking/vosdata/ReVOS/meta_expressions_valid_.json")
    parser.add_argument("--mask_path", type=str, default="/video_vit/tracking/vosdata/ReVOS/mask_dict.json")
    parser.add_argument("--foreground_mask_path", type=str, default="/video_vit/tracking/vosdata/ReVOS/mask_dict_foreground.json")
