...
if __name__ == '__main__':
    ...
    parser.add_argument("--pred_path", type=str, default="/mnt/data1/zwk/sa2va/work_dirs/1B-s2-9-16/MEVIS_U/results.json")
    parser.add_argument("--mevis_exp_path", type=str,
                        default="/mnt/data1/zwk/data/rvos/MeViS/valid_u/meta_expressions.json")
    parser.add_argument("--mevis_mask_path", type=str,
                        default="/mnt/data1/zwk/data/rvos/MeViS/valid_u/mask_dict.json")
