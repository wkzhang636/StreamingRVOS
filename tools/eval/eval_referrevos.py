...
import sys
sys.path.append("/mnt/data1/zwk/sa2va")
...
if __name__ == '__main__':
    ...
    parser.add_argument("--pred_path", type=str, default="/mnt/data1/zwk/sa2va/work_dirs/Sa2VA-1B/REREVOS/results.json")
    parser.add_argument("--exp_path", type=str, default="/mnt/data1/zwk/data/rvos/ReVOS/refering_split.json")
    parser.add_argument("--mask_path", type=str, default="/mnt/data1/zwk/data/rvos/ReVOS/mask_dict.json")
    parser.add_argument("--foreground_mask_path", type=str, default="/mnt/data1/zwk/data/rvos/ReVOS/mask_dict_foreground.json")
