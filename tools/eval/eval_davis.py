...
if __name__ == '__main__':
    ...
    parser.add_argument("--pred_path", type=str, default='/mnt/data1/zwk/sa2va/work_dirs/2B-s2-9-29/DAVIS/results.json',)
    parser.add_argument("--mevis_exp_path", type=str,
                        default="/mnt/data1/zwk/data/rvos/Ref-DAVIS17/meta_expressions/valid/meta_expressions.json")
    parser.add_argument("--mevis_mask_path", type=str,
                        default="/mnt/data1/zwk/data/rvos/Ref-DAVIS17/valid/mask_dict.pkl")
